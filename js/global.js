...
function validaPassword(password, password2) {
    ...
    if (password.val().trim().length == 0) {
        notificaErrore(password,"Inserire una nuova <span lang='en'> password </span> valida",$("#mod-pwd-form").prev(".alert.errore"),$("#mod-pwd-form"));
        passwordValide = false;
    }
    else if (password2.val().trim().length == 0) {
        notificaErrore(password2,"Si prega di ripetere la nuova <span lang='en'> password </span>",$("#mod-pwd-form").prev(".alert.errore"),$("#mod-pwd-form"));
        passwordValide = false;
    }
    else if (password.val() != password2.val()) {
        notificaErrore(password2,"Le <span lang='en'> password </span> non combaciano",$("#mod-pwd-form").prev(".alert.errore"),$("#mod-pwd-form"));
        passwordValide = false;
    }
